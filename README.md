# Hybrid SIEM & LLM Security Alert Correlation Engine
...
### 3. Satellite & WAN Perimeter Overlay (Starlink)
...
* **`starlink_cgnat_bypassed`** — Anomalous Ground Station POP Shifts & BGP Latency Anomalies
